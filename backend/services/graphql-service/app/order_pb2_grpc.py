...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.RefundOrder = channel.unary_unary(
                '/order.OrderService/RefundOrder',
                request_serializer=order__pb2.RefundRequest.SerializeToString,
                response_deserializer=order__pb2.OrderResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'RefundOrder': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__pb2.RefundRequest.FromString,
                    response_serializer=order__pb2.OrderResponse.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    def RefundOrder(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order.OrderService/RefundOrder',
            order__pb2.RefundRequest.SerializeToString,
            order__pb2.OrderResponse.FromString,
            options,
            channel_credentials,
            insecure,
